...
public class controllerPromiseAdmin implements Initializable {
...
//        });
    ...
    @FXML private void refreshTable(){
        ...
        idclient.setCellValueFactory(new PropertyValueFactory<com.example.kimmo.Promesse,Integer>("idClient"));
        idAppart.setCellValueFactory(new PropertyValueFactory<com.example.kimmo.Promesse,Integer>("idAppartement"));
        idavocat.setCellValueFactory(new PropertyValueFactory<com.example.kimmo.Promesse,Integer>("idAvocat"));
        issign.setCellValueFactory(new PropertyValueFactory<com.example.kimmo.Promesse,Integer>("isSign"));
        prix_vente.setCellValueFactory(new PropertyValueFactory<com.example.kimmo.Promesse,Float>("prix_ventel"));
        avance.setCellValueFactory(new PropertyValueFactory<com.example.kimmo.Promesse,Float>("avance"));
